...
INFO = {
    'cifar-10-1': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/cifar-10-1.npz?download=1',
    ...
    'cifar-10-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/cifar-10-c.npz?download=1',
    ...
    'cifar-100-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/cifar-100-c.npz?download=1',
    ...
    'eurosat': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/eurosat.npz?download=1',
    ...
    'eurosat-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/eurosat-c.npz?download=1',
    ...
    'bloodmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/bloodmnist-c.npz?download=1',
    ...
    'breastmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/breastmnist-c.npz?download=1',
    ...
    'dermamnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/dermamnist-c.npz?download=1',
    ...
    'octmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/octmnist-c.npz?download=1',
    ...
    'organamnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/organamnist-c.npz?download=1',
    ...
    'organcmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/organcmnist-c.npz?download=1',
    ...
    'organsmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/organsmnist-c.npz?download=1',
    ...
    'pathmnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/pathmnist-c.npz?download=1',
    ...
    'pneumoniamnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/pneumoniamnist-c.npz?download=1',
    ...
    'tissuemnist-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tissuemnist-c.npz?download=1',
    ...
    'tiny-imagenet': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tiny-imagenet.npz?download=1',
    ...
    'tiny-imagenet-a': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tiny-imagenet-a.npz?download=1',
    ...
    'tiny-imagenet-c': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tiny-imagenet-c.npz?download=1',
    ...
    'tiny-imagenet-r': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tiny-imagenet-r.npz?download=1',
    ...
    'tiny-imagenet-v2': {
        ...
        'url': 'https://sandbox.zenodo.org/records/91410/files/tiny-imagenet-v2.npz?download=1',
